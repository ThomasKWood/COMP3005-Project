/** 
 * A4 Client for handling order
 * @version 1.0
 * @author Unknown
 * Responsible for processing and verifying order info to be sent to server.
**/
 ...
 * @return {String} string that contains the html for the drop-down list
**/
 ...
 * @return {String} string that contains html for the left column
**/
 ...
 * @return {String} string that contains html for the middle column
**/
 ...
 * @return {Object} an item object if it exists
**/
